...
export interface IAttributeSchemaDataBase {
  type: string
  value: any
}

export type IAttributeSchemaData =
  | IActionAttributeSchemaData
  | IStringAttributeSchemaData
  | IStateAttributeSchemaData
  | INumberAttributeSchemaData
  | IBooleanAttributeSchemaData
  | II18nAttributeSchemaData
  | IJsonAttributeSchemaData
  | IObjectAttributeSchemaData

export interface IActionAttributeSchemaData extends IAttributeSchemaDataBase {
  type: 'action'
  value: string
}

export interface IStateAttributeSchemaData extends IAttributeSchemaDataBase {
  type: 'state'
  value: string
}

export interface IStringAttributeSchemaData extends IAttributeSchemaDataBase {
  type: 'string'
  value: string
}

export interface INumberAttributeSchemaData extends IAttributeSchemaDataBase {
  type: 'number'
  value: number
}

export interface IBooleanAttributeSchemaData extends IAttributeSchemaDataBase {
  type: 'boolean'
  value: boolean
}

export interface II18nAttributeSchemaData extends IAttributeSchemaDataBase {
  type: 'i18n'
  value: {
...
export interface IJsonAttributeSchemaData extends IAttributeSchemaDataBase {
  type: 'json'
  value: JsonTypeObject
}

export interface IObjectAttributeSchemaData extends IAttributeSchemaDataBase {
  type: 'object'
  value: {
    [dataKey: string]: IAttributeSchemaData
  }
}
...
export interface ITemplateConfig {
  text?: string
  tag?: string
  attributes?: Record<string, IAttributeSchemaData>
